...
const workflowContent = `Trae Automation Workflow v2.0 (Strict Mode)
=============================================
...
const outputPath = path.join(process.cwd(), 'workflow_v2.0.txt');
fs.writeFileSync(outputPath, workflowContent, 'utf8');
console.log(`Workflow document generated at: ${outputPath}`);
